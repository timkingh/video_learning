// Ex13_02C.cpp : Defines the entry point for the application.
// Timing parallel and serial computation of the Mandelbrot set
                     ...
                     int       nCmdShow)
{
	...
	LoadString(hInstance, IDC_EX13_02C, szWindowClass, MAX_LOADSTRING);
